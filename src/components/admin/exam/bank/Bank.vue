...
export default {
    setup() {
        ...
        const columns = ref([
            ...
            { title: '描述', width: '260px', key: 'content' },
        ...
        const fetch_article = async (pageSize) => {
            BankApi.getBankList({ current: page.current, pageSize: pageSize }).then((res) => {
        ...
        const remove = () => {
            ...
            BankApi.deleteBankById({id:selectedKeys.value[0]}).then((res) => {
                layer.msg('Success', { icon: 1 }, () => {
